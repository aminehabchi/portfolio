...
import { Download, Github, Linkedin, Trophy, Mail, MapPin, Book } from "lucide-react";

const InfoSection = ({ handleDownloadCV }) => {
    return (
        <section className="relative overflow-hidden bg-gray-900/70 py-24 px-6">
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="text-center lg:text-left flex-1">
                    ...
                    <p className="text-gray-400 mb-6 leading-relaxed max-w-2xl">
                        I develop full-stack web applications using React.js, Next.js, Angular, Java, and Go.
                        I build real-time features with WebSockets, implement REST APIs, design databases, and create
                        interactive, responsive frontends. I also handle authentication, state management, and optimize
